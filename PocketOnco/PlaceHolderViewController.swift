//
//  placeHolderViewControlllerViewController.swift
//  PocketOnco
//
...
public class PlaceHolderViewController: UIViewController {
 ...
 var index = 0
    ...
    public override func viewDidLoad() {
        ...
        tip.text = PlaceHolderViewController.textArray[0]
      
        tip.numberOfLines = -1
        tip.textAlignment = .center
        
        icon.addTarget(self, action: #selector(self.homePageAction), for: .touchUpInside)
